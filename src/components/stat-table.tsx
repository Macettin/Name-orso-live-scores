...
export function PlayerStatTable({ players, teams }: { players: Player[]; teams: Team[] }) {
  const lookupData = { tournaments: [], teams, players: [], matches: [], events: [], matchLineups: [], playerMatchStats: [], matchTeamStats: [], officials: [], matchOfficials: [], tournamentApplications: [], newsPosts: [], mediaItems: [], sponsors: [], teamStaff: [], adminNotificationReads: [] } satisfies TournamentData;
