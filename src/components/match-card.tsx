    ...
    <Card className="flex flex-col gap-5 border-slate-200/90 p-5 shadow-[0_14px_34px_rgba(15,23,42,0.08)] transition hover:border-blue-200 hover:shadow-[0_18px_42px_rgba(37,99,235,0.12)]">
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-4">
        ...
        <Link
          ...
          className="rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 px-5 py-3 text-center text-2xl font-black leading-none !text-white shadow-md shadow-blue-900/25 ring-1 ring-blue-500/20 hover:from-blue-700 hover:to-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 sm:min-w-28"
        >
