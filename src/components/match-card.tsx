...
export function MatchCard({ match, teams }: { match: Match; teams?: Team[] }) {
  ...
  const lookupData = { tournaments: [], teams: teamData, players: [], matches: [], events: [], matchLineups: [], playerMatchStats: [], matchTeamStats: [], officials: [], matchOfficials: [], tournamentApplications: [], newsPosts: [] };
